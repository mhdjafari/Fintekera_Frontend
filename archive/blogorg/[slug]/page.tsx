          ...
          <div className="flex flex-wrap justify-center -mx-4">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div className="flex flex-wrap items-center justify-between pb-4 mb-10 border-b border-stroke dark:border-stroke-dark">
                  <div className="flex flex-wrap items-center">
                    ...
                    <div className="flex items-center mb-5">
                      <p className="flex items-center mr-5 text-base text-body-color dark:text-body-color-dark">
                        <span className="mr-3">
                          <svg
                            width="15"
                            height="15"
                  ...
                  <div className="mb-5">
                    <Link
                      href={`/blogs/tags/${post?.tags[0]}`}
                      className="inline-flex items-center justify-center px-4 py-2 text-sm font-semibold text-white duration-300 rounded-full bg-primary hover:bg-primary/90"
                    >
