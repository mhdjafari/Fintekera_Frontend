            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="mx-auto text-center mb-9">
                  <div className="justify-center dark:hidden">
                    <svg
                ...
                <Link
                  href="/"
                  className="py-4 text-base font-medium text-white duration-300 rounded-sm bg-primary px-9 shadow-submit hover:bg-primary/90 dark:shadow-submit-dark"
                >
                  Back to Homepage
                </Link>
              </div>
