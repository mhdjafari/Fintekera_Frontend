...
const checkEmailInDatabase = async (userData) => {
  try {
    ...
    const response = await fetch(
      "https://api.fintekera.com/admin/resend-email-token-fin",
      {
        method: "POST",
        headers: {
    ...
    const userData = {
      email: enteredEmail.toString(),
        ...
        try {
          ...
          if (responseData === "Verification email is resent.") {
            // Redirect to the success page after successful submission
            window.location.href = "https://www.fintekera.com/verification-email-success";
          } else {
  ...
  return (
    <>
      <section className="flex justify-center pb-12.5 pt-32.5 lg:pb-25 lg:pt-45 xl:pb-30 xl:pt-50">
        <div className="relative z-1 max-w-c-1016 px-7.5 pb-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
            ...
            <form>
                ...
                <div className="flex flex-wrap items-center gap-10 md:justify-start xl:gap-15">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2.5 rounded-full bg-black px-7.5 mb-4 mt-4 py-3 font-medium text-white duration-300 ease-in-out hover:bg-blackho dark:bg-btndark dark:hover:bg-blackho"
                  ...
                  >
                    ...
                    <Link
                    href="/auth/signin"
                    className="flex rounded-full items-center bg-black px-7.5 py-3 mb-4 mt-4 text-white duration-300 ease-in-out hover:bg-blackho dark:bg-btndark dark:hover:bg-blackho"
                    style={{ height: '40px' }} // Set height to match button
                  >
                    Back
                  </Link>
