...
const checkEmailInDatabase = async (userData) => {
  try {
    ...
    const response = await fetch(
      "https://api.fintekera.com/admin/reset-password-fin",
      {
        method: "POST",
        headers: {
...
const ResetPassword = () => {
  ...
  const handleCurrentPassChange = (event) => {
    ...
    setCurrentPassError(""); // Clear any existing error message when user starts typing
  };
  ...
  const handleSubmit = async (event) => {
    ...
    const userData = {
      ...
      current_password: currentPass.toString(),
...
//       console.log(responseData);
      if (responseData === "Password is reset successfully.") {
        ...
        window.location.href = "https://www.fintekera.com/reset-password-success";
      } else {
