...
const saveSubsNewsToDatabase = async (userData) => {
  try {
    ...
    if (response.ok) {
      console.log("Subscriber's email is saved successfully!");
    } else {
      console.error("Error saving user email:", response.statusText);
    }
  } catch (error) {
    console.error("Error saving user email:", error.message);
  }
};
...
const Footer = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await saveSubsNewsToDatabase(userData);
      // Set state to show the "Thank You!" message
            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <a
                  ...
                  className="text-itemtitle3 font-medium text-black dark:text-white"
                >
                  info@fintekera.com
                </a>
                    ...
                    <div className="relative">
                      ...
                      />
                       {emailError && (
                         ...
                         {showThankYou && (
                            <p className="text-green-500 font-bold mr-2 text-center">Thank You!</p>
                          )}
                          {!showThankYou && (
                             <button
